...
def MHu_sampler_one_o(observation, ST_old, k, alpha, mu, lamb, var):
    # basic information
    ...
    OMEGA_old = get_omega(alpha_old, k)
    OMEGA_new = get_omega(alpha_new, k)
...
def MHusampler_o(observation, pi_0, sample_n, T_interval, k, mu, lamb, var):
    alpha_list = []
    ST_list = []
    alpha_old = 3.0
    ...
    for i in range(sample_n):
        ST_new, alpha_new = MHu_sampler_one_o(observation, ST_old, k, alpha_old, mu, lamb, var)
