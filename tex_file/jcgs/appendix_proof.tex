...
%   P(V_{i + 1} =s|V_i=s, W, X, \theta, \vartheta) &
%  = \frac{P( V_{i + 1} = s, X | V_i = s, W, \theta, \vartheta)}{P(X | W,
%  \theta, \vartheta)} \\
% &= \frac{P(X | V_i = V_{i + 1} = s, W, \theta, \vartheta)P( 
% V_{i + 1} = s|V_i =s, W, \theta, \vartheta)}{P(X | W, \theta, \vartheta)}\\
% & \geq \frac{\lb}{\ub} P( V_{i + 1} = s | V_i = s, W, \theta, \vartheta)\\
