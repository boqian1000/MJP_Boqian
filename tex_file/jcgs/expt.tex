...
carrying out parameter inference.
  ...
  \begin{minipage}[!hp]{0.45\linewidth}
  \centering
    \includegraphics [width=.9\textwidth, angle=0]{figs/jc_model.pdf}
    \caption{Jukes-Cantor (JC69) model}
	\label{jc_model}
  \end{minipage}
  \begin{minipage}[!hp]{0.4\linewidth}
  \centering
    \includegraphics [width=0.8\textwidth, angle=0]{figs/jc.pdf}
    \vspace{-0.4in}
...
%$\alpha | s_0,S,T$ is following $Gamma(\mu+ N,\lambda + 3(t_{end} - t_{start}))$\\
  ...
  \begin{minipage}[!hp]{0.45\linewidth}
  \centering
    \includegraphics [width=0.7\textwidth, angle=0]{figs/ESS_vs_t_alpha_JC.pdf}
  \end{minipage}
  \begin{minipage}[!hp]{0.45\linewidth}
  \centering
    \includegraphics [width=0.75\textwidth, angle=0]{figs/ESS_vs_t_alpha_fixobservation_JC.pdf}
  \end{minipage}
...
% \end{figure}
  ...
  \centering
    \includegraphics [width=0.45\textwidth, angle=0]{figures_new_apr12/Q_alpha_dim3_18apr12.pdf}
    \hspace{.2in}
    \includegraphics [width=0.45\textwidth, angle=0]{figures_new_apr12/Q_beta_dim3_18apr12.pdf}
%    \vspace{-1.0 in}
  \end{minipage}
  \begin{minipage}[!hp]{0.7\linewidth}
  \centering
    \includegraphics [width=0.45\textwidth, angle=0]{figures_new_apr12/Q_alpha_dim10_18apr12.pdf}
    \hspace{.2in}
    \includegraphics [width=0.45\textwidth, angle=0]{figures_new_apr12/Q_beta_dim10_18apr12.pdf}
 %   \vspace{-0.5 in}
  \end{minipage}
...
% not included it).  
 ...
 shifting the optimal setting of the proposal variance to smaller values.
  ...
  \centering
    \includegraphics [width=0.42\textwidth, angle=0]{figures_new_apr12/CQ_alpha_dim3_18apr12.pdf}
    \hspace{.2 in}
    \includegraphics [width=0.42\textwidth, angle=0]{figures_new_apr12/CQ_beta_dim3_18apr12.pdf}
%    \vspace{-.81 in}
  \end{minipage}
  \begin{minipage}[!hp]{0.75\linewidth}
  \centering
    \includegraphics [width=0.420\textwidth, angle=0]{figures_new_apr12/CQ_alpha_dim10_18apr12.pdf}
    \hspace{.2 in}
    \includegraphics [width=0.420\textwidth, angle=0]{figures_new_apr12/CQ_beta_dim10_18apr12.pdf}
%    \vspace{-.5in}
  \end{minipage}
...
%    \vspace{-.81 in}
  ...
  \begin{minipage}[!hp]{0.7\linewidth}
  \centering
    \includegraphics [width=0.42\textwidth, angle=0]{figs/ECOLI_beta.pdf}
    \hspace{.2 in}
    \includegraphics [width=0.42\textwidth, angle=0]{figs/ECOLI_l2.pdf}
  %  \vspace{-.5in}
  \end{minipage}
    \caption{ESS/sec the ECOLI data.}
     \label{fig:ECOLI}
  \end{figure}
