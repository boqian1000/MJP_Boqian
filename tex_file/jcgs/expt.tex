...
%$\alpha | s_0,S,T$ is following $Gamma(\mu+ N,\lambda + 3(t_{end} - t_{start}))$\\
  ...
  \centering
    \includegraphics [width=0.5\textwidth, angle=0]{figures_new_apr12/alpha_ESS_T_JC_nonfix_18apr12.pdf}
	\vspace{.3in}
  \centering
    \includegraphics [width=0.5\textwidth, angle=0]{figures_new_apr12/alpha_ESS_T_JC_fix_18apr12.pdf}
  \end{minipage}
