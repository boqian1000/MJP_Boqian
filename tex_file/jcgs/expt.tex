...
claim one is uniformly superior to the other.
  ...
  \begin{minipage}[hp]{0.24\linewidth}
  \centering
    \includegraphics [width=0.99\textwidth, angle=0]{figures_new_apr12/alpha_ESS_T_fix_18apr12.pdf}
    \end{minipage}
  \begin{minipage}[hp]{0.24\linewidth}
  \centering
    \includegraphics [width=0.99\textwidth, angle=0]{figures_new_apr12/beta_ESS_T_fix_18apr12.pdf}
%    \vspace{-0.3in}
  \end{minipage}
    %\label{fig:TSS_fix}
  \begin{minipage}[hp]{0.24\linewidth}
  \centering
    \includegraphics [width=0.99\textwidth, angle=0]{figures_new_apr12/alpha_ESS_T_nonfix_18apr12.pdf}
      \end{minipage}
  \begin{minipage}[hp]{0.24\linewidth}
  \centering
    \includegraphics [width=0.99\textwidth, angle=0]{figures_new_apr12/beta_ESS_T_nonfix_18apr12.pdf}
  \end{minipage}
%    \vspace{-0.3in}
...
%$\alpha | s_0,S,T$ is following $Gamma(\mu+ N,\lambda + 3(t_{end} - t_{start}))$\\
  ...
  \centering
    \includegraphics [width=0.45\textwidth, angle=0]{figures_new_apr12/alpha_ESS_T_JC_nonfix_18apr12.pdf}
	\vspace{.3in}
  \centering
    \includegraphics [width=0.45\textwidth, angle=0]{figures_new_apr12/alpha_ESS_T_JC_fix_18apr12.pdf}
  \end{minipage}
...
%    \vspace{-.5in}
  \end{minipage}
  \begin{minipage}[!hp]{0.30\linewidth}
  ...
  \centering
    \includegraphics [width=0.25\textwidth, angle=0]{figures_new_apr12/ecoli_alpha_18apr12.pdf}
    \includegraphics [width=0.25\textwidth, angle=0]{figures_new_apr12/ecoli_l1_18apr12.pdf}
%    \vspace{-.81 in}
