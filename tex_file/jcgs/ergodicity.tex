...
$\lambda_1 > 0$, within which our sampler forgets its current state with 
...
If $\sup_\theta \Omega(\theta) = M_\theta < \infty$, we just need 
...
\mathbb{E}[|U'| |W, \theta, \vartheta, X] &= \mathbb{E}_{S,T, \ptheta}\mathbb{E}[|U'| | S, T, W, \theta, \ptheta, X] = \mathbb{E}_{S,T, \ptheta}\mathbb{E}[|U'| | S, T, W, \theta, \ptheta] \\
...
\end{align*}
%Let $\mathbb{E}\left[\Omega(\theta') | W, \theta, \vartheta, X\right]=
