...
$\prod P(x_o | s_o, \theta) \in [\lb, \ub]$ for any state $s_o$ and $\theta$.%\vinayak{Is this for all $s_o$?}
  \label{asmp:obs_bnd}
\end{assumption}
...
& \geq \frac{\lb}{\ub} (1-\frac{1}{k}) \doteq \delta_1 > 0
\end{align*}
\end{proof}
...
& \alpha_I(\theta', \theta;X)q(\theta'|\theta)\\
  &\boqian{? \text{assumption 4 should be stronger.}}\\
