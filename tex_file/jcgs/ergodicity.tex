...
aggressively.
The next corollary follows from a simple application of the Cauchy-Schwarz inequality, see the appendix for the proof.
\begin{corollary}
...
For reference, we repeat some of our notation in the appendix.
% \{?
