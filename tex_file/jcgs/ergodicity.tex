...
matrix to be well-conditioned over all parameters of interest\boqian{?: the most
...
\end{align*}
For $\theta$ satisfying $ \parallel \theta \parallel >\max(\theta_2, \theta_3, \theta_\epsilon)$, we have %\boqian{need to change afterwards}
\begin{align*}
